const SOCIALS = [
  ...
  {
    href: 'https://www.instagram.com/johora_ava',
    label: 'Instagram',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    href: 'https://www.facebook.com/johora.ava22',
    label: 'Facebook',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    <footer id="contact" className="bg-slate-900 text-slate-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          {/* Identity */}
          <div>
            <h3 className="text-white font-semibold text-base mb-1">Fatema Tuj Johora</h3>
            <p className="text-sm text-slate-400 mb-3">Ph.D. Student · Computer Science</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-slate-400">Dallas, Texas</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-1.5 text-sm">
              {['#about', '#news', '#research', '#cv', '#publications', '#projects', '#skills'].map(href => (
                <li key={href}>
                  <a
                    href={href}
